...
public:
    ...
    void displayByDistance() {
        if (isEmpty()) {
            ...
            Node* current = front;
            while (current != nullptr) {
                cout << "ID Halaman: " << current->idHalaman << " - Nama Peserta: " << current->namaPeserta<< " - Jarak ke Kegiatan: " << current->alamatPeserta.jarakKeKegiatan << " km" << endl;
                current = current->next;
            }
        }
    }
    ...
    void displayMiddle() {
        if (isEmpty()) {
            ...
            cout << " - ID Halaman: " << slow->idHalaman << endl;
            cout << " - Nama Peserta: " << slow->namaPeserta << endl;
        }
    }
    ...
    void searchById(const string& idHalaman) {
        ...
        while (current != nullptr) {
            if (current->idHalaman == idHalaman) {
                ...
                cout << " - Nama Peserta: " << current->namaPeserta << endl;
                return;
            }
            current = current->next;
        }
...
private:
    string generateIdHalaman() {
        ...
        return "mbuL_" + to_string(counter++);
    }
};
